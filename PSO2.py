...
def PSA():
    ...
    while not feito:
        if epoca < numeroEpocas:
            ...
            print("Atualizando velocidade")
            atualizaVelocidade(gMelhor)

            print("Atualizando particulas")
            atualizaParticulas(gMelhor)

            print "*****  ÉPOCA: "+ str(epoca)
            print "Peso: " + str(particulas[gMelhor].pesoTotal) + ", Valor: " + str(particulas[gMelhor].valorTotal) + "\n\n"
            epoca += 1
        else:
            feito = True
    return
