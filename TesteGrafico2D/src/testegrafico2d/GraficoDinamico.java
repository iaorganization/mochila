...
//        trace3.setTracePainter(new TracePainterDisc(4));
        ...
        btnStartGenetico.addActionListener(e -> {
            Runnable task2 = () -> {
                executaPrograma("python main.py", "exit.txt", "erro.txt", dadosPython);
            };
            new Thread(task2).start();

            Runnable task3 = () -> {
                executaPrograma("python main.py", "exit.txt", "erro.txt", dadosPython2);
            };
            new Thread(task3).start();

            Runnable task4 = () -> {
                executaPrograma("python main.py", "exit.txt", "erro.txt", dadosPython3);
            };
...
//        configuraJPanel(jp, jButton3, jButton5, jButton4);
...
//        c.add(new ChartPanel(chart), BorderLayout.CENTER);
    ...
    private static void defineNimbusLook() {
...
//                    System.out.println(geracao + "," + valor);
                }
